     ...
     <div class="col-md-12">
         ...
         <div class="panel-group joined" id="accordion-test-2">
             ...
             <div class="panel panel-default">
                 <div class="panel-heading">
                     <h4 class="panel-title">
                         <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapseAddOne-2">
                             <?php echo get_phrase('educational_background'); ?>
                         </a>
                     </h4>
                 </div>
                 <div id="collapseAddOne-2" class="panel-collapse collapse">
                     <div class="panel-body" style="background-color: white;">
                         <?php  echo form_open(site_url('admin/employee_edit/educational_background/') . $row['user_code'], array('class' => 'form-horizontal form-groups-bordered')); ?>
                         <?php include 'employee_education_edit.php'; ?>
                         <?php echo form_close(); ?>
                     </div>
                 </div>
             </div>
                 ...
                 <div id="collapseFive-2" class="panel-collapse collapse">
                     <div class="panel-body" style="background-color: white;">
                         ...
                         <div class="col-md-12">
                             ...
                             <a href="javascript:;"
                                 onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_job_history_add/'.$user_id); ?>');"
                                                 ...
                                                 <td>
                                                     <div class="btn-group">
                                                         <button type="button" class="btn btn-info btn-sm "
                                                             onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_job_history_edit/'.$row['job_history_id'].'/'.$user_id); ?>');">
