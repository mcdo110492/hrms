...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs bordered">
            ...
            <li>
                <a href="#education_details" data-toggle="tab">
                    <span class="visible-xs"><i class="entypo-user"></i></span>
                    <span class="hidden-xs"><?php echo get_phrase('educational_background'); ?></span>
                </a>
            </li>
            <li>
        ...
        <div class="tab-content" style="padding: 20px;">
            <div class="tab-pane active" id="personal_details">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><b><?php if($row['date_of_birth'] != '') echo date('d/m/Y', $row['date_of_birth']); ?></b>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><b><?php if($row['martial_status']!= null) { echo get_phrase($row['martial_status']); } ?></b>
                        </td>
                    </tr>
            ...
            <div class="tab-pane" id="company_details">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><b><?php if($row['department_id']!=null ) echo $this->db->get_where('department', array('department_id' => $row['department_id']))->row()->name; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('designation');?></td>
                        <td><b><?php if($row['department_id']!=null ) echo $this->db->get_where('designation', array('designation_id' => $row['designation_id']))->row()->name; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('date_of_joining');?></td>
                        <td><b><?php if($row['date_of_joining'] != '') echo date('d/m/Y', $row['date_of_joining']); ?></b>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><b><?php if($row['date_of_leaving'] != '') echo date('d/m/Y', $row['date_of_leaving']); ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('status');?></td>
                        <td><b><?php if($row['status'] == 1) echo get_phrase('active'); else echo get_phrase('inactive'); ?></b>
                        </td>
                    </tr>
            ...
            <div class="tab-pane" id="education_details">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td><?php echo get_phrase('elementary_school');?></td>
                        <td><b><?php if($education != null ) echo $education->elementary_school; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('elementary_date_graduated');?></td>
                        <td><b><?php if($education != null ) echo $education->elementary_date_grad; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('highschool');?></td>
                        <td><b><?php if($education != null ) echo $education->highschool; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('highschool_date_graduated');?></td>
                        <td><b><?php if($education != null ) echo $education->highschool_date_grad; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('college');?></td>
                        <td><b><?php if($education != null ) echo $education->college_school; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('college_date_graduated');?></td>
                        <td><b><?php if($education != null ) echo $education->college_date_grad; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('course');?></td>
                        <td><b><?php if($education != null ) echo $education->course; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('special_skills');?></td>
                        <td><b><?php if($education != null ) echo $education->special_skills; ?></b>
                        </td>
                    </tr>

                    <tr>
                        <td><?php echo get_phrase('others');?></td>
                        <td><b><?php if($education != null ) echo $education->others; ?></b>
                        </td>
                    </tr>
            ...
            <div class="tab-pane" id="document">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('uploads/document/resume/'). $documents->resume; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('uploads/document/offer_letter/'). $documents->offer_letter; ?>"
                                class="btn btn-blue btn-icon icon-left">
                                <i class="entypo-download"></i>
                                <?php echo get_phrase('download') ?>
                            </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('uploads/document/joining_letter/'). $documents->joining_letter; ?>"
                                class="btn btn-blue btn-icon icon-left">
                                <i class="entypo-download"></i>
                                <?php echo get_phrase('download') ?>
                            </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('uploads/document/contract_agreement/'). $documents->contract_agreement; ?>"
                                class="btn btn-blue btn-icon icon-left">
                                <i class="entypo-download"></i>
                                <?php echo get_phrase('download') ?>
                            </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('uploads/document/others/'). $documents->others; ?>"
                                class="btn btn-blue btn-icon icon-left">
                                <i class="entypo-download"></i>
                                <?php echo get_phrase('download') ?>
                            </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="tile-stats tile-gray">
                            ...
                            <p>
                                <strong>
                                    <?php echo date('d M Y', $history['timestamp_from']); ?> -
                                    <?php echo date('d M Y', $history['timestamp_to']); ?>
                                </strong>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                ...
                                <strong class="pull-right" style="font-size: 12px;">
                                    ...
                                    <?php echo date('d M Y', $complaint['timestamp']); ?>
                                </strong>
                                <hr>
