    ...
    <div class="col-md-12">
        ...
        <div class="panel-group joined" id="accordion-test-2">
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne-2" class="panel-collapse collapse">
                    <div class="panel-body" style="background-color: white;">
                        <?php  echo form_open(site_url('employee/profile/personal_details/'). $row['user_code'], array('class' => 'form-horizontal form-groups-bordered')); ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapseeduc-2"
                            class="collapsed">
                            <?php echo get_phrase('educational_background'); ?>
                        </a>
                    </h4>
                </div>
                <div id="collapseeduc-2" class="panel-collapse collapse">
                    <div class="panel-body" style="background-color: white;">
                        <?php  echo form_open(site_url('employee/profile/educational_background/'). $row['user_code'], array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data')); ?>
                        <?php include 'employee_educational_background_edit.php'; ?>
                        <?php echo form_close(); ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapseFour-2"
                            class="collapsed">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapseFive-2"
                            class="collapsed">
                ...
                <div id="collapseFive-2" class="panel-collapse collapse">
                    <div class="panel-body" style="background-color: white;">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="javascript:;"
                                onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_job_history_add'); ?>');"
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <div><?php echo get_phrase('company_name'); ?></div>
                                                </th>
                                                <th>
                                                    <div><?php echo get_phrase('department'); ?></div>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <div><?php echo get_phrase('edit'); ?></div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-info btn-sm "
                                                            onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_job_history_edit/'.$row['job_history_id'].'/'.$this->session->userdata('login_user_id')); ?>');">
